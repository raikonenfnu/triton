...
module attributes {ttg.maxnreg = 168 : i32, "ttg.num-ctas" = 1 : i32, "ttg.num-warps" = 4 : i32, ttg.target = "cuda:100", "ttg.threads-per-warp" = 32 : i32} {
  tt.func public @_attn_fwd_persist(%arg0: f32, %arg1: !tt.ptr<f32> {tt.divisibility = 16 : i32}, %arg2: i32 {tt.divisibility = 16 : i32}, %arg3: i32, %arg4: !tt.tensordesc<tensor<64x128xbf16, #ttg.nvmma_shared<{swizzlingByteWidth = 128, transposed = false, elementBitWidth = 16}>>>, %arg5: i32, %arg6: i32, %arg7: i64, %arg8: i64, %arg9: !tt.tensordesc<tensor<128x128xbf16, #ttg.nvmma_shared<{swizzlingByteWidth = 128, transposed = false, elementBitWidth = 16}>>>, %arg10: i32, %arg11: i32, %arg12: i64, %arg13: i64, %arg14: !tt.tensordesc<tensor<128x128xbf16, #ttg.nvmma_shared<{swizzlingByteWidth = 128, transposed = false, elementBitWidth = 16}>>>, %arg15: i32, %arg16: i32, %arg17: i64, %arg18: i64, %arg19: !tt.tensordesc<tensor<64x128xbf16, #ttg.nvmma_shared<{swizzlingByteWidth = 128, transposed = false, elementBitWidth = 16}>>>, %arg20: i32, %arg21: i32, %arg22: i64, %arg23: i64, %arg24: i32 {tt.divisibility = 16 : i32}) attributes {noinline = false} {
    ...
    scf.for %arg25 = %c0_i32 to %9 step %c1_i32  : i32 {
      ...
      %527 = arith.divsi %10, %arg3 {ttg.partition = 3 : i32} : i32
      %528 = arith.addi %527, %12 {ttg.partition = 3 : i32} : i32
      %529 = arith.addi %528, %13 {ttg.partition = 3 : i32} : i32
      ...
      %532 = arith.addi %529, %c64_i32 {ttg.partition = 3 : i32} : i32
      ...
      %35 = ttng.tmem_store %cst_0, %tmem_acc1[%token_8], %true {ttg.partition = 0 : i32} : tensor<64x128xf32, #ttg.blocked<{sizePerThread = [1, 64], threadsPerWarp = [16, 2], warpsPerCTA = [4, 1], order = [0, 1]}>> -> !ttg.memdesc<64x128xf32, #ttng.tensor_memory_encoding<blockM = 64, blockN = 128, colStride = 1>, #ttng.tensor_memory, mutable>
      %36 = ttng.tmem_store %cst_0, %tmem_acc0[%token_4], %true {ttg.partition = 0 : i32} : tensor<64x128xf32, #ttg.blocked<{sizePerThread = [1, 64], threadsPerWarp = [16, 2], warpsPerCTA = [4, 1], order = [0, 1]}>> -> !ttg.memdesc<64x128xf32, #ttng.tensor_memory_encoding<blockM = 64, blockN = 128, colStride = 1>, #ttng.tensor_memory, mutable>
      %37:9 = scf.for %arg26 = %c0_i32 to %arg24 step %c128_i32 iter_args(%arg27 = %cst_2, %arg28 = %cst_2, %arg29 = %cst_1, %arg30 = %cst_1, %arg31 = %28, %arg32 = %token, %arg33 = %36, %arg34 = %token_6, %arg35 = %35) -> (tensor<64xf32, #ttg.slice<{dim = 1, parent = #ttg.blocked<{sizePerThread = [1, 64], threadsPerWarp = [16, 2], warpsPerCTA = [4, 1], order = [0, 1]}>}>>, tensor<64xf32, #ttg.slice<{dim = 1, parent = #ttg.blocked<{sizePerThread = [1, 64], threadsPerWarp = [16, 2], warpsPerCTA = [4, 1], order = [0, 1]}>}>>, tensor<64xf32, #ttg.slice<{dim = 1, parent = #ttg.blocked<{sizePerThread = [1, 64], threadsPerWarp = [16, 2], warpsPerCTA = [4, 1], order = [0, 1]}>}>>, tensor<64xf32, #ttg.slice<{dim = 1, parent = #ttg.blocked<{sizePerThread = [1, 64], threadsPerWarp = [16, 2], warpsPerCTA = [4, 1], order = [0, 1]}>}>>, i32, !ttg.async.token, !ttg.async.token, !ttg.async.token, !ttg.async.token)  : i32 {
        ...
        %56 = ttg.memdesc_trans %55 {loop.cluster = 0 : i32, loop.stage = 2 : i32, order = array<i32: 1, 0>, ttg.partition = 5 : i32} : !ttg.memdesc<128x128xbf16, #ttg.nvmma_shared<{swizzlingByteWidth = 128, transposed = false, elementBitWidth = 16}>, #ttg.shared_memory, mutable> -> !ttg.memdesc<128x128xbf16, #ttg.nvmma_shared<{swizzlingByteWidth = 128, transposed = true, elementBitWidth = 16}>, #ttg.shared_memory, mutable>
        ...
        %59 = ttng.tc_gen5_mma %31, %56, %tmem_qk0[%arg32], %false, %true {loop.cluster = 0 : i32, loop.stage = 2 : i32, tt.self_latency = 1 : i32, ttg.partition = 5 : i32} : !ttg.memdesc<64x128xbf16, #ttg.nvmma_shared<{swizzlingByteWidth = 128, transposed = false, elementBitWidth = 16}>, #ttg.shared_memory, mutable>, !ttg.memdesc<128x128xbf16, #ttg.nvmma_shared<{swizzlingByteWidth = 128, transposed = true, elementBitWidth = 16}>, #ttg.shared_memory, mutable>, !ttg.memdesc<64x128xf32, #ttng.tensor_memory_encoding<blockM = 64, blockN = 128, colStride = 1>, #ttng.tensor_memory, mutable>

        // First softmax in partition 1
        // consumer of 1st channel: qk0
        %reg_qk0, %token_14 = ttng.tmem_load %tmem_qk0[%59] {loop.cluster = 0 : i32, loop.stage = 2 : i32, ttg.partition = 1 : i32} : !ttg.memdesc<64x128xf32, #ttng.tensor_memory_encoding<blockM = 64, blockN = 128, colStride = 1>, #ttng.tensor_memory, mutable> -> tensor<64x128xf32, #ttg.blocked<{sizePerThread = [1, 64], threadsPerWarp = [16, 2], warpsPerCTA = [4, 1], order = [0, 1]}>>
        ...
        ttng.tmem_store %1005, %alpha0, %true {ttg.partition = 1 : i32} : tensor<64x1xf32, #ttg.blocked<{sizePerThread = [1, 1], threadsPerWarp = [16, 2], warpsPerCTA = [4, 1], order = [0, 1]}>> -> !ttg.memdesc<64x1xf32, #ttng.tensor_memory_encoding<blockM = 64, blockN = 1, colStride = 1>, #ttng.tensor_memory, mutable>
        ...
        %reg_acc0, %token_16 = ttng.tmem_load %tmem_acc0[%arg33] {loop.cluster = 0 : i32, loop.stage = 2 : i32, ttg.partition = 0 : i32} : !ttg.memdesc<64x128xf32, #ttng.tensor_memory_encoding<blockM = 64, blockN = 128, colStride = 1>, #ttng.tensor_memory, mutable> -> tensor<64x128xf32, #ttg.blocked<{sizePerThread = [1, 64], threadsPerWarp = [16, 2], warpsPerCTA = [4, 1], order = [0, 1]}>>
        ...
        %1169 = ttng.tmem_load %alpha0 {ttg.partition = 0 : i32} : !ttg.memdesc<64x1xf32, #ttng.tensor_memory_encoding<blockM = 64, blockN = 1, colStride = 1>, #ttng.tensor_memory, mutable> -> tensor<64x1xf32, #ttg.blocked<{sizePerThread = [1, 1], threadsPerWarp = [16, 2], warpsPerCTA = [4, 1], order = [0, 1]}>>
        ...
        ttng.tmem_store %81, %tmem_p0, %true {loop.cluster = 0 : i32, loop.stage = 2 : i32, ttg.partition = 1 : i32} : tensor<64x128xbf16, #ttg.blocked<{sizePerThread = [1, 64], threadsPerWarp = [16, 2], warpsPerCTA = [4, 1], order = [0, 1]}>> -> !ttg.memdesc<64x128xbf16, #ttng.tensor_memory_encoding<blockM = 64, blockN = 128, colStride = 1>, #ttng.tensor_memory, mutable> // p0
        ...
        // consumer of p0
        %84 = ttng.tc_gen5_mma %tmem_p0, %58, %tmem_acc0[%83], %true, %true {loop.cluster = 0 : i32, loop.stage = 2 : i32, tt.self_latency = 1 : i32, ttg.partition = 5 : i32} : !ttg.memdesc<64x128xbf16, #ttng.tensor_memory_encoding<blockM = 64, blockN = 128, colStride = 1>, #ttng.tensor_memory, mutable>, !ttg.memdesc<128x128xbf16, #ttg.nvmma_shared<{swizzlingByteWidth = 128, transposed = false, elementBitWidth = 16}>, #ttg.shared_memory, mutable>, !ttg.memdesc<64x128xf32, #ttng.tensor_memory_encoding<blockM = 64, blockN = 128, colStride = 1>, #ttng.tensor_memory, mutable>
        ...
        // consumer of qk1
        %reg_qk1, %token_19 = ttng.tmem_load %tmem_qk1[%87] {loop.cluster = 0 : i32, loop.stage = 2 : i32, ttg.partition = 2 : i32} : !ttg.memdesc<64x128xf32, #ttng.tensor_memory_encoding<blockM = 64, blockN = 128, colStride = 1>, #ttng.tensor_memory, mutable> -> tensor<64x128xf32, #ttg.blocked<{sizePerThread = [1, 64], threadsPerWarp = [16, 2], warpsPerCTA = [4, 1], order = [0, 1]}>>
        ...
        ttng.tmem_store %1015, %alpha1, %true {ttg.partition = 2 : i32} : tensor<64x1xf32, #ttg.blocked<{sizePerThread = [1, 1], threadsPerWarp = [16, 2], warpsPerCTA = [4, 1], order = [0, 1]}>> -> !ttg.memdesc<64x1xf32, #ttng.tensor_memory_encoding<blockM = 64, blockN = 1, colStride = 1>, #ttng.tensor_memory, mutable>
        ...
        %1197 = ttng.tmem_load %alpha1 {ttg.partition = 0 : i32} : !ttg.memdesc<64x1xf32, #ttng.tensor_memory_encoding<blockM = 64, blockN = 1, colStride = 1>, #ttng.tensor_memory, mutable> -> tensor<64x1xf32, #ttg.blocked<{sizePerThread = [1, 1], threadsPerWarp = [16, 2], warpsPerCTA = [4, 1], order = [0, 1]}>>
        ...
        ttng.tmem_store %109, %tmem_p1, %true {loop.cluster = 0 : i32, loop.stage = 2 : i32, ttg.partition = 2 : i32} : tensor<64x128xbf16, #ttg.blocked<{sizePerThread = [1, 64], threadsPerWarp = [16, 2], warpsPerCTA = [4, 1], order = [0, 1]}>> -> !ttg.memdesc<64x128xbf16, #ttng.tensor_memory_encoding<blockM = 64, blockN = 128, colStride = 1>, #ttng.tensor_memory, mutable> // p1
      ...
      ttng.tmem_store %1205, %l_i0, %true {ttg.partition = 1 : i32} : tensor<64x1xf32, #ttg.blocked<{sizePerThread = [1, 1], threadsPerWarp = [16, 2], warpsPerCTA = [4, 1], order = [0, 1]}>> -> !ttg.memdesc<64x1xf32, #ttng.tensor_memory_encoding<blockM = 64, blockN = 1, colStride = 1>, #ttng.tensor_memory, mutable>

      // Part of the epilogue is in correction
      // consumer of l_i in correction
      %1269 = ttng.tmem_load %l_i0 {ttg.partition = 0 : i32} : !ttg.memdesc<64x1xf32, #ttng.tensor_memory_encoding<blockM = 64, blockN = 1, colStride = 1>, #ttng.tensor_memory, mutable> -> tensor<64x1xf32, #ttg.blocked<{sizePerThread = [1, 1], threadsPerWarp = [16, 2], warpsPerCTA = [4, 1], order = [0, 1]}>>
      ...
      ttng.tmem_store %2205, %m_i0, %true {ttg.partition = 1 : i32} : tensor<64x1xf32, #ttg.blocked<{sizePerThread = [1, 1], threadsPerWarp = [16, 2], warpsPerCTA = [4, 1], order = [0, 1]}>> -> !ttg.memdesc<64x1xf32, #ttng.tensor_memory_encoding<blockM = 64, blockN = 1, colStride = 1>, #ttng.tensor_memory, mutable>
      // consumer of a channel: %37#2 m_i0
      %2269 = ttng.tmem_load %m_i0 {ttg.partition = 0 : i32} : !ttg.memdesc<64x1xf32, #ttng.tensor_memory_encoding<blockM = 64, blockN = 1, colStride = 1>, #ttng.tensor_memory, mutable> -> tensor<64x1xf32, #ttg.blocked<{sizePerThread = [1, 1], threadsPerWarp = [16, 2], warpsPerCTA = [4, 1], order = [0, 1]}>>
      ...
      %reg_acc0_ce, %token_10 = ttng.tmem_load %tmem_acc0[%37#6] {ttg.partition = 0 : i32} : !ttg.memdesc<64x128xf32, #ttng.tensor_memory_encoding<blockM = 64, blockN = 128, colStride = 1>, #ttng.tensor_memory, mutable> -> tensor<64x128xf32, #ttg.blocked<{sizePerThread = [1, 64], threadsPerWarp = [16, 2], warpsPerCTA = [4, 1], order = [0, 1]}>>
      ...
      %1145 = ttg.local_load %out0 {ttg.partition = 3 : i32} : !ttg.memdesc<64x128xbf16, #ttg.nvmma_shared<{swizzlingByteWidth = 128, transposed = false, elementBitWidth = 16}>, #ttg.shared_memory, mutable> -> tensor<64x128xbf16, #ttg.blocked<{sizePerThread = [1, 1], threadsPerWarp = [1, 32], warpsPerCTA = [1, 4], order = [1, 0]}>>
      tt.descriptor_store %arg19[%529, %c0_i32], %1145 {ttg.partition = 3 : i32} : !tt.tensordesc<tensor<64x128xbf16, #ttg.nvmma_shared<{swizzlingByteWidth = 128, transposed = false, elementBitWidth = 16}>>>, tensor<64x128xbf16, #ttg.blocked<{sizePerThread = [1, 1], threadsPerWarp = [1, 32], warpsPerCTA = [1, 4], order = [1, 0]}>>
      ...
      ttng.tmem_store %1305, %l_i1, %true {ttg.partition = 2 : i32} : tensor<64x1xf32, #ttg.blocked<{sizePerThread = [1, 1], threadsPerWarp = [16, 2], warpsPerCTA = [4, 1], order = [0, 1]}>> -> !ttg.memdesc<64x1xf32, #ttng.tensor_memory_encoding<blockM = 64, blockN = 1, colStride = 1>, #ttng.tensor_memory, mutable>
      // consumer of l_i1
      %1369 = ttng.tmem_load %l_i1 {ttg.partition = 0 : i32} : !ttg.memdesc<64x1xf32, #ttng.tensor_memory_encoding<blockM = 64, blockN = 1, colStride = 1>, #ttng.tensor_memory, mutable> -> tensor<64x1xf32, #ttg.blocked<{sizePerThread = [1, 1], threadsPerWarp = [16, 2], warpsPerCTA = [4, 1], order = [0, 1]}>>
      ...
      ttng.tmem_store %2305, %m_i1, %true {ttg.partition = 2 : i32} : tensor<64x1xf32, #ttg.blocked<{sizePerThread = [1, 1], threadsPerWarp = [16, 2], warpsPerCTA = [4, 1], order = [0, 1]}>> -> !ttg.memdesc<64x1xf32, #ttng.tensor_memory_encoding<blockM = 64, blockN = 1, colStride = 1>, #ttng.tensor_memory, mutable>
      // consumer of a channel %37#3 m_i1
      %2369 = ttng.tmem_load %m_i1 {ttg.partition = 0 : i32} : !ttg.memdesc<64x1xf32, #ttng.tensor_memory_encoding<blockM = 64, blockN = 1, colStride = 1>, #ttng.tensor_memory, mutable> -> tensor<64x1xf32, #ttg.blocked<{sizePerThread = [1, 1], threadsPerWarp = [16, 2], warpsPerCTA = [4, 1], order = [0, 1]}>>
      ...
      %reg_acc1_ce, %token_12 = ttng.tmem_load %tmem_acc1[%37#8] {ttg.partition = 0 : i32} : !ttg.memdesc<64x128xf32, #ttng.tensor_memory_encoding<blockM = 64, blockN = 128, colStride = 1>, #ttng.tensor_memory, mutable> -> tensor<64x128xf32, #ttg.blocked<{sizePerThread = [1, 64], threadsPerWarp = [16, 2], warpsPerCTA = [4, 1], order = [0, 1]}>>
      ...
      %1153 = ttg.local_load %out1 {ttg.partition = 3 : i32} : !ttg.memdesc<64x128xbf16, #ttg.nvmma_shared<{swizzlingByteWidth = 128, transposed = false, elementBitWidth = 16}>, #ttg.shared_memory, mutable> -> tensor<64x128xbf16, #ttg.blocked<{sizePerThread = [1, 1], threadsPerWarp = [1, 32], warpsPerCTA = [1, 4], order = [1, 0]}>>
      tt.descriptor_store %arg19[%532, %c0_i32], %1153 {ttg.partition = 3 : i32} : !tt.tensordesc<tensor<64x128xbf16, #ttg.nvmma_shared<{swizzlingByteWidth = 128, transposed = false, elementBitWidth = 16}>>>, tensor<64x128xbf16, #ttg.blocked<{sizePerThread = [1, 1], threadsPerWarp = [1, 32], warpsPerCTA = [1, 4], order = [1, 0]}>>
